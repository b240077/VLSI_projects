...
REM
REM Generated by Vivado on Thu Jun 25 01:01:31 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_sequence_detector_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_sequence_detector_vlog.prj -log xvlog.log
