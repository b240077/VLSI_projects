...
REM
REM Generated by Vivado on Fri Jun 26 19:03:13 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_shift_registers_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_shift_registers_vlog.prj -log xvlog.log
