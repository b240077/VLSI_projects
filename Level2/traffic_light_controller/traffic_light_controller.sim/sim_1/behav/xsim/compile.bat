...
REM
REM Generated by Vivado on Wed Jun 24 15:14:28 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_traffic_light_controller_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_traffic_light_controller_vlog.prj -log xvlog.log
