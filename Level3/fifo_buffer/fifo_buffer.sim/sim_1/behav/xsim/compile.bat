...
REM
REM Generated by Vivado on Sun Jun 28 22:47:05 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_fifo_buffer_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_fifo_buffer_vlog.prj -log xvlog.log
