...
REM
REM Generated by Vivado on Sun Jun 28 17:46:25 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_eight_bit_ALU_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_eight_bit_ALU_vlog.prj -log xvlog.log
