...
REM
REM Generated by Vivado on Mon Jun 29 22:03:48 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_spi_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_spi_vlog.prj -log xvlog.log
