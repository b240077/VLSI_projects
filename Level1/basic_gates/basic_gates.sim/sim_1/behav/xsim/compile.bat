...
REM
REM Generated by Vivado on Sat Jun 20 18:39:37 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj test_basic_gates_vlog.prj"
call xvlog  --incr --relax -L uvm -prj test_basic_gates_vlog.prj -log xvlog.log
