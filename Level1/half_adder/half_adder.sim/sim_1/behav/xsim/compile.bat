...
REM
REM Generated by Vivado on Mon Jun 22 12:44:38 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_halfadder_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_halfadder_vlog.prj -log xvlog.log
