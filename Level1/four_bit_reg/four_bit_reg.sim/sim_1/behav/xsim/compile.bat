...
REM
REM Generated by Vivado on Tue Jun 23 16:03:07 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_register_4bit_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_register_4bit_vlog.prj -log xvlog.log
