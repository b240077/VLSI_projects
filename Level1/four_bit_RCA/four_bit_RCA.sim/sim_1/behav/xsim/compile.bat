...
REM
REM Generated by Vivado on Mon Jun 22 15:58:44 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_full_adder_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_full_adder_vlog.prj -log xvlog.log
