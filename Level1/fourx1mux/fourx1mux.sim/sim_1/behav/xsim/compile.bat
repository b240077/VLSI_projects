...
REM
REM Generated by Vivado on Sun Jun 21 18:04:56 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_fourx1mux_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_fourx1mux_vlog.prj -log xvlog.log
