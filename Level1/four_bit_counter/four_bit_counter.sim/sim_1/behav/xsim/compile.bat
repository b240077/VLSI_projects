...
REM
REM Generated by Vivado on Wed Jun 24 00:36:27 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_four_bit_counter_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_four_bit_counter_vlog.prj -log xvlog.log
