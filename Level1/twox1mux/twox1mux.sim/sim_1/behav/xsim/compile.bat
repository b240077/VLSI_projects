...
REM
REM Generated by Vivado on Sun Jun 21 17:31:10 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_twox1mux_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_twox1mux_vlog.prj -log xvlog.log
